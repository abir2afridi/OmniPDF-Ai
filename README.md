...
| E-Sign | Add digital signatures and initials |
...
- **Translate** — Translate PDF content between 12+ languages
...
Firebase config is hardcoded in `lib/firebase.ts` (public identifiers only).
...
```
├── components/      # React UI components (38 modules)
