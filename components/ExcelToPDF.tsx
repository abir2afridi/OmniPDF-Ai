        ...
        <div className="flex-1 flex flex-col h-full bg-[#f3f1ea] dark:bg-[#1e1e2e] overflow-hidden relative">
            ...
            <div className="shrink-0 flex items-center justify-between px-4 lg:px-6 py-4 bg-[#f3f1ea] dark:bg-[#262636] border-b border-gray-100 dark:border-white/5 shadow-sm">
                <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                        ...
                        <p className="text-[11px] text-gray-400 font-medium truncate">Convert .xlsx workbooks to PDF — choose sheets, styles preserved</p>
                    </div>
                </div>
            ...
            <div className="flex-1 flex flex-col lg:flex-row overflow-y-auto lg:overflow-hidden">
                    ...
                    <div ref={dropRef} onDragOver={onDragOver} onDragLeave={onDragLeave} onDrop={onDrop}
                        ...
                        {files.length === 0 ? (
                            ...
                            <div className="flex items-center justify-center gap-3 text-sm text-gray-400 font-medium">
                                ...
                                <span>Click or drag to <span className="text-green-500 font-bold">add more files</span></span>
                            </div>
                        )}
                    </div>
                ...
                <div className="lg:w-80 w-full shrink-0 flex flex-col border-l-0 lg:border-l border-gray-100 dark:border-white/5 bg-[#f3f1ea] dark:bg-[#262636] lg:overflow-y-auto">
                    ...
                    {/* Action Buttons */}
                    <div className="p-5 border-t border-gray-100 dark:border-white/5 bg-[#f3f1ea]/80 dark:bg-[#262636]/80 backdrop-blur-sm sticky bottom-0 z-10 space-y-3">
                        <button
                            onClick={convertAll}
