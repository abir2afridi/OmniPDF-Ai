...
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
  ...
  <Relationship Id="rId5" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/theme" Target="theme/theme1.xml"/>
    ...
    // Helper to create a slide with text boxes
    function makeSlide(slideNum, title, body) {
...
<p:sld xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main">
  <p:cSld>
    <p:spTree>
      ...
      <p:sp>
        <p:nvSpPr><p:cNvPr id="3" name="Body"/><p:cNvSpPr><a:spLocks noGrp="1"/></p:cNvSpPr><p:nvPr><p:ph type="obj"/></p:nvPr></p:nvSpPr>
        <p:spPr>
          <a:xfrm><a:off x="457200" y="1600200"/><a:ext cx="8229600" cy="3143100"/></a:xfrm>
          <a:prstGeom prst="rect"><a:avLst/></a:prstGeom>
        </p:spPr>
        <p:txBody>
          <a:bodyPr/>
    ...
    // Slide 1: Bengali title + body
    zip.file('ppt/slides/slide1.xml', makeSlide(1,
        'বাংলাদেশের ইতিহাস',
        'বাংলাদেশ দক্ষিণ এশিয়ায় অবস্থিত একটি সার্বভৌম রাষ্ট্র। ১৯৭১ সালে পাকিস্তানের থেকে মুক্তিযুদ্ধের মাধ্যমে স্বাধীনতা অর্জন করে। এটি বিশ্বের অষ্টম জনবহুল দেশ।'
    ));

    // Slide 2: Mixed Bengali + English
    zip.file('ppt/slides/slide2.xml', makeSlide(2,
        'মিশ্র ভাষা — Mixed Language',
        'এটি একটি পরীক্ষামূলক স্লাইড।\nThis is a test slide.\nবাংলা এবং English উভয় ভাষাই ব্যবহৃত হয়েছে।'
    ));

    // Slide 3: Bengali with numbers and punctuation
    zip.file('ppt/slides/slide3.xml', makeSlide(3,
        'সংখ্যা ও চিহ্ন — Numbers & Symbols',
        '১. প্রথম পয়েন্ট — First point\n২. দ্বিতীয় পয়েন্ট — Second point\n৩. তৃতীয় পয়েন্ট — Third point\n\nগুরুত্বপূর্ণ তথ্য: ২০২৬ সালে বাংলাদেশের জনসংখ্যা প্রায় ১৭০ মিলিয়ন।'
    ));
...
<p:sldMaster xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main">
  ...
  <p:sldStyle>
    <a:majorFont Latin="Calibri" ea="Arial" cs="Arial"/>
    <a:minorFont Latin="Calibri" ea="Arial" cs="Arial"/>
  </p:sldStyle>
</p:sldMaster>`);
...
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
  <Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/slideLayout" Target="../slideLayouts/slideLayout1.xml"/>
    ...
    const outPath = path.join(__dirname, '..', 'public', 'test-bengali.pptx');
